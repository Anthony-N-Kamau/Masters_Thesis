#!/bin/bash
#SBATCH --job-name=ifa_v_fullshuffle_gutenberg
#SBATCH --partition=gpu_a100
#SBATCH --gpus=1
#SBATCH --time=02:00:00
#SBATCH --output=logs/ifa_vinfo_fullshuffle_gutenberg_%j.out
#SBATCH --error=logs/ifa_vinfo_fullshuffle_gutenberg_%j.out
