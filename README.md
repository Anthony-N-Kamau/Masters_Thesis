...
Clone the repo and check out the thesis branch:

```bash
git clone https://github.com/amirhoseinMhmd/Impossible_projects.git
cd Impossible_projects
git checkout Project-2-Lightweight-vs-Mechanistic
```
